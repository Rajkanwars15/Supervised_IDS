...
print(f"\nGenerating bin-based distribution plots...")
for col in tqdm(numeric_cols, desc="Creating plots", unit="plot"):
    ...
    # Save as PNG
    try:
        png_path = figs_dir / f"{col}_bin_distribution.png"
