"""
Decision Stump (1-Rule) Experiment for SensorNetGuard
...
print("="*80)
print("Decision Stump Experiment - SensorNetGuard")
print("="*80)
...
print(f"  Rule: if {top_feature} <= {threshold:.6f} then Benign, else Malicious")
