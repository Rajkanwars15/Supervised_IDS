"""
Decision Tree Experiment for Farm-Flow Binary Classification Dataset

This script trains a decision tree classifier on the Farm-Flow dataset and logs:
...
# Set paths
data_dir = Path(__file__).parent.parent.parent.parent / "data" / "farm-flow-silver"
train_path = data_dir / "Farm-Flow_Train_Binary.csv"
test_path = data_dir / "Farm-Flow_Test_Binary.csv"

# Check if silver data exists, otherwise use original
if not train_path.exists() or not test_path.exists():
    print("Silver data not found. Using original data...")
    data_dir = Path(__file__).parent.parent.parent.parent / "data" / "farm-flow" / "Datasets"
    train_path = data_dir / "Farm-Flow_Train_Binary.csv"
    test_path = data_dir / "Farm-Flow_Test_Binary.csv"
...
with open(tree_text_file, 'w') as f:
    f.write(f"Decision Tree Structure - Farm-Flow Experiment {timestamp}\n")
    f.write("="*80 + "\n\n")
    f.write(tree_rules)
...
results = {
    ...
    'dataset': 'Farm-Flow Binary Classification',
